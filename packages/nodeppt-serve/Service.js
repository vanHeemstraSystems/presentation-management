...
module.exports = class Service {
    constructor(context, entry, {plugins, pkg, useBuiltIn, nodepptOptions} = {}) {
        ...
        // This is the configuration passed by nodeppt, mainly using version. . .
    ...
    init(mode) {
        ...
        this.plugins.forEach(({id, apply}) => {
            if (id.indexOf('markdown') === 0 || id.indexOf('posthtml') === 0) {
                // If it starts with markdown and posthtml, it is not a service plugin, but a markdown-it and posthtml plugin
                return;
            }
