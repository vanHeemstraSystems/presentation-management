...
- Written in markdown syntax based on GFM
- Supports html mixed layout, even complex demos can be made!
- Export web pages or pdf for easier sharing
- Support single-page background images
- Multiple modes: overview mode, dual-screen mode, remote control
- Can use drawing boards, can use notes to make notes
- Support syntax highlighting, free choice of highlight style
- Can have internal animations for single-page ppt, single-step animations
- Support entry/exit callbacks, very convenient for making online demos
{.build.fadeIn}
